...
Moldura do app — barra inferior flutuante no app e encostada na web (com preferência do aparelho), 48px só
de ícones, rail em paisagem e superfície neutra, com as armadilhas do `ion-tab-bar` que só
