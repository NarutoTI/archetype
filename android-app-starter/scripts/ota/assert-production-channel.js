 ...
 * zip OTA): o bundle nunca pode assar `staging` como canal inicial. Um bundle
 * promovido carregando `staging` jogaria devices de produção (sem preferência
 * local) para o `otaStaging`.
 *
